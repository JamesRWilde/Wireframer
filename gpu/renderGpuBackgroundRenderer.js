/**
 * renderGpuBackgroundRenderer.js - Main render function for GPU background renderer
 *
 * PURPOSE:
 ...
 *     - renderGpuBackground: function - Helper to issue draw call.
 ...
 *
 * USAGE:
 *   particleCount = renderGpuBackgroundRenderer({ gl, locations, buffer, params, needsRebuild, rebuildBuffer, renderGpuBackground, particleCount });
 *
 ...
 */
export function renderGpuBackgroundRenderer(opts) {
  const { gl, locations, buffer, params, needsRebuild, rebuildBuffer, renderGpuBackground, particleCount: prevCount } = opts;
