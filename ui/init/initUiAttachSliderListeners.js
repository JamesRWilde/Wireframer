...
import { setUiSyncRenderToggles } from '../set/setUiSyncRenderToggles.js';
 ...
 */
export function initUiAttachSliderListeners(sliders, lodSlider, SetMeshEngineDetailLevel) {
  try {
