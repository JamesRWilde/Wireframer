 ...
 * @param {Function} setDetailLevel - Callback to trigger model decimation (0-1 range)
 ...
 */
export function initUiAttachSliderListeners(sliders, lodSlider, setDetailLevel) {
  try {
