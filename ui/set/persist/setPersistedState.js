...
import {bgDensity,bgOpacity,bgVelocity,fillOpacity,lodSlider,select,themeModeEl,wireOpacity} from '@ui/state/stateDom.js';
 ...
 */
export function setPersistedState(objects = []) {
