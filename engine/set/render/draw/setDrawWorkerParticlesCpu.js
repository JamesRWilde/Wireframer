...
/**
 * setDrawWorkerParticlesCpu - Renders bucketed particles using fillRect with alpha-based batching
 *
 ...
 */
export function setDrawWorkerParticlesCpu(ctx, buckets, colorRgb) {
