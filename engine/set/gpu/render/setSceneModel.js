 ...
 */
export function setSceneModel(gl, model, params, shaderPack, bufferStore, tmpArrays) {
  ...
  if (fillAlpha > 0.001) {
    ...
    gl.uniform3fv(fillLoc.uLightDir, getNormalizedVector3(tmpLight, params.lightDir, [-0.38, 0.74, -0.56]));
