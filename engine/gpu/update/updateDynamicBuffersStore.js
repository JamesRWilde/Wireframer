 ...
 *
 * This function is a strict one-function-per-file wrapper that delegates all logic to the updateDynamicBuffers helper.
 ...
 * - Delegates all update logic to updateDynamicBuffers.js, which handles the actual buffer updates.
 ...
 */
import { updateDynamicBuffers as updateDynamicBuffersHelper } from './updateDynamicBuffers.js';

/**
 * Updates the dynamic buffers for a model's GPU buffer store by delegating to the updateDynamicBuffers helper.
 * @param {WebGLRenderingContext} gl
 * @param {Object} model
 * @param {Object} buffers
 * @returns {boolean}
 */
export function updateDynamicBuffersStore(gl, model, buffers) {
  // Delegate to the main update logic in updateDynamicBuffers.js
