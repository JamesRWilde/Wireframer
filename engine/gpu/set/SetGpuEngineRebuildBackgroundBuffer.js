 ...
 */
import { createParticleBuffer } from '../init/InitGpuEngineCreateBackgroundParticleBuffer.js';

export function SetGpuEngineRebuildBackgroundBuffer(gl, buffer, particles) {
