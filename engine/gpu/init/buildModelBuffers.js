 ...
 * - Delegates:
 *   - Vertex position buffer creation to createWirePosData.
 *   - Fill position, normal, and UV buffer creation to createFillBuffers.
 *   - Edge index buffer creation to createEdgeIndexData.
...
export function buildModelBuffers(gl, model, supportsUint32) {
  ...
  const wirePosData = createWirePosData(model);
