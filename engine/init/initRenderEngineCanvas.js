import { bgState } from '../state/stateRenderEngineBackground.js';
import { setRenderEngineSyncCanvasSize } from '../set/setRenderEngineSyncCanvasSize.js';

export function initRenderEngineCanvas() {
