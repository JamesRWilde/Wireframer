 ...
 * - dynamicBuffers(model, buffers): Updates the dynamic fill position and normal buffers for the given model and buffer set.
 *
 ...
 * @returns {{ modelBuffers: function(Object): Object|null, dynamicBuffers: function(Object, Object): boolean }}
 */
import { modelBuffers }from '@engine/get/gpu/modelBuffers.js';
import { dynamicBuffersStore }from '@engine/set/gpu/update/dynamicBuffersStore.js';
...
export function sceneBufferStore(gl, supportsUint32) {
  ...
  return {
    ...
    dynamicBuffers: (model, buffers) => dynamicBuffersStore(gl, model, buffers)
  };
}
