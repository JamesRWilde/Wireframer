...
import { gpuEngineCreateScenePrograms } from './gpuEngineCreateScenePrograms.js';

// Import buffer store creation
// Manages vertex buffers for fill positions, normals, and wire edges
import { gpuEngineCreateSceneBufferStore } from './gpuEngineCreateSceneBufferStore.js';

// Import draw API creation
// Provides SetGpuEngineRenderModel and clear functions for WebGL rendering
import { gpuEngineCreateSceneDraw } from './gpuEngineCreateSceneDraw.js';

export function gpuEngineCreateSceneRenderer(canvas) {
