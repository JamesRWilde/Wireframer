...
import { getMeshEngineFilterValidEdges } from '../get/getMeshEngineFilterValidEdges.js';

// Import mesh validation to ensure data integrity
import { getMeshEngineValidate } from '../get/getMeshEngineValidate.js';

// Import LOD range setup for detail level control
import { setMeshEngineLodRangeForModel } from '../set/setMeshEngineLodRangeForModel.js';

// Import camera fitting to frame the model properly
import { initMeshEngineFitCameraToModel } from './initMeshEngineFitCameraToModel.js';

// Import model finalization (activation, morph setup)
import { initMeshEngineFinalizeModel } from './initMeshEngineFinalizeModel.js';

// Import edge building utility
// Register globally so any consumer can invoke it without circular imports
import { initMeshEngineBuildEdgesFromFacesRuntime } from './initMeshEngineBuildEdgesFromFacesRuntime.js';
 ...
 */
export function initMeshEngineLoad(mesh, name = 'Shape', options = {}) {
