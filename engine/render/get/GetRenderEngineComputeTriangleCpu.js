...
import { GetRenderEngineLerpColor } from './GetRenderEngineLerpColor.js';
 ...
 */
export function GetRenderEngineComputeTriangleCpu(normal, useSmoothShading) {
  ...
  return GetRenderEngineLerpColor(THEME.shadeDark, THEME.shadeBright, lit);
}
