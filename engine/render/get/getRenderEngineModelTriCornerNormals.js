...
import { getCpuEngineModelShadingMode } from ''../../cpu/get/getCpuEngineModelShadingMode.js'';
import { getCpuEngineModelFaceNormals } from ''../../cpu/get/getCpuEngineModelFaceNormals.js'';
import { geometrySumNormals } from ''../../cpu/get/getCpuEngineGeometrySumNormals.js'';
import { initCpuEngineBuildVertexToFaces } from ''../../cpu/init/initCpuEngineBuildVertexToFaces.js'';
import { geometryGetFlatNormals } from ''../../cpu/get/getCpuEngineGeometryFlatNormals.js'';
import { geometryGetTriNormals } from ''../../cpu/get/getCpuEngineGeometryTriNormals.js'';

export function getRenderEngineModelTriCornerNormals(model, triFaces) {
