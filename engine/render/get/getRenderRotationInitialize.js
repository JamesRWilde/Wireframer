...
import { getRenderMatrixMultiply3x3 } from './getRenderMatrixMultiply3x3.js';

// Import Y-axis rotation matrix constructor
import { getRenderRotationMatrixY } from './getRenderRotationMatrixY.js';
 ...
 */
export function getRenderRotationInitialize() {
  ...
  if (typeof mry === 'function' && typeof mrx === 'function' && typeof mmul === 'function') {
    ...
    R.value = getRenderMatrixMultiply3x3(getRenderRotationMatrixY(0.4), getRenderRotationMatrixX(0.18));
  } else {
