...
import { setMixedRenderFlags } from '../../set/setMixedRenderFlags.js';
 ...
 */
export function setRenderScene(nowMs) {
  ...
  if (state.foregroundRenderMode === 'gpu') {
    ...
    if (!gpuDrawn) {
      drewCpuForeground = setRenderCpuPath(meshToRender, backgroundOnSeparateCanvas);
    }
  } else {
