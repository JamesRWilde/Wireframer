import { initRenderCreateParticle } from '../init/initRenderCreateParticle.js';
...
export function setRenderSeedParticles(particles, w, h) {
  ...
  if (mustReseed || !particles.length || sizeChanged) {
    ...
    for (let i = 0; i < count; i++) {
      particles.push(initRenderCreateParticle(w, h, velocityScale));
    }
    lastSize = { w, h };
    lastDensity = density;
  }
