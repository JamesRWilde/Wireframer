...
import { drawGpuSceneModel } from ''../../gpu/set/setGpuEngineDrawSceneModel.js'';

// Import the fallback function to switch to CPU mode when GPU fails
// This updates the render mode and HUD display
import { fallbackToCpuForegroundMode } from ''../../set/setEngineCpuForegroundMode.js'';
 ...
 */
export function setRenderEngineGpuPath(meshToRender, morphing) {
  ...
  let gpuDrawn = drawGpuSceneModel(meshToRender, {
    ...
    // Visual parameters
    theme: globalThis.THEME,       // Color theme for fill/wire
