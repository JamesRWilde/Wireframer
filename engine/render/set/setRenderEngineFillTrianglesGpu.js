...
"use strict";
import { resolveTriangleNormal } from ''../get/getRenderEngineResolveTriangleNormalGpu.js'';
import { computeTriangleShadeColor } from ''../get/getRenderEngineComputeTriangleGpu.js'';
import { expandTriangleForSeam } from ''../get/getRenderEngineExpandSeamGpu.js'';
import { fillTriangle } from ''../../cpu/set/setCpuEngineFillTriangle.js'';

export function setRenderEngineFillTrianglesGpu({ T, P2, triFaces, triCornerNormals, useSmoothShading, theme, fillAlpha, seamExpandPx, R, ctx }) {
