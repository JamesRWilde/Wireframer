...
"use strict";
import { resolveTriangleNormal } from '../get/getRenderResolveTriangleNormalGpu.js';
import { computeTriangleShadeColor } from '../get/getRenderComputeTriangleGpu.js';
import { expandTriangleForSeam } from '../get/getRenderExpandSeamGpu.js';
import { fillTriangle } from '../../cpu/set/setCpuFillTriangle.js';

export function setRenderFillTrianglesGpu({ T, P2, triFaces, triCornerNormals, useSmoothShading, theme, fillAlpha, seamExpandPx, R, ctx }) {
