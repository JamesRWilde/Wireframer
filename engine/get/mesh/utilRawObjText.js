/**
 * rawObjText.js - Raw OBJ Text Validation
 * 
 * PURPOSE:
...
/**
 * rawObjText - Validates and splits raw OBJ text
 * 
 ...
 */
export function utilRawObjText(rawObjText, overrides = {}) {
  ...
  if (!Array.isArray(lines) || lines.length === 0) {
    console.error('[toRuntime] OBJ lines array is invalid or empty.', lines);
    throw new Error('[toRuntime] OBJ lines array is invalid or empty');
  }
