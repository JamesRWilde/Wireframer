...
import { getFaceNormal } from '@engine/get/mesh/getFaceNormal.js';
import { getDot3 } from '@engine/get/mesh/getDot3.js';
 ...
 */
export function getFixedWinding(meshObj) {
  const V = meshObj.V;
  const F = meshObj.F;
