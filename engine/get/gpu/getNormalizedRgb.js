/**
 * getNormalizedRgb.js - RGB to Normalized Color Converter
 *
 * PURPOSE:
...
/**
 * getNormalizedRgb - Converts RGB [0-255] to normalized [0-1] in place
 *
 ...
 */
export function getNormalizedRgb(out, rgb, fallback) {
