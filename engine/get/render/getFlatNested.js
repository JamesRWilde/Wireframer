/**
 * getFlatNested.js - Flat Array to Nested Array Converter
 *
 * PURPOSE:
...
/**
 * getFlatNested - Converts flat vertex/position arrays to nested format
 *
 ...
 */
export function getFlatNested(flatT, flatP2, vertexCount) {
