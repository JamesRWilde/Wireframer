...
import { getLerpColor }from '@engine/get/render/getLerpColor.js';
export function getTriangleGpu(normal, useSmoothShading, theme) {
  ...
  return getLerpColor(theme.shadeDark || [0, 0, 0], theme.shadeBright || [255, 255, 255], lit);
}
