/**
 * getShouldRunFrame.js - Frame Rate Throttling
 * 
 * PURPOSE:
...
import { state, MIN_FRAME_INTERVAL_MS }from '@engine/state/stateLoop.js';

/**
 * getShouldRunFrame - Checks if the current frame should run or be skipped
 * 
