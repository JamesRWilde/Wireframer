...
import { idxFromToken } from './InitMeshEngineParseIdxFromToken.js';

// Import vertex deduplication helper
import { GetMeshEngineOrCreateVertIdx } from '../get/GetMeshEngineOrCreateVertIdx.js';
 ...
 */
export function InitMeshEngineParseFace(parts, originalLine, state) {
