 ...
 */
export function initMeshEngineBuildObject(uniqueVerts, faces) {
  ...
  if (!globalThis.InitMeshEngineBuildEdgesFromFacesRuntime) {
    ...
    const { initMeshEngineBuildEdgesFromFacesRuntime } = require(''./initMeshEngineBuildEdgesFromFacesRuntime.js'');
    globalThis.InitMeshEngineBuildEdgesFromFacesRuntime = InitMeshEngineBuildEdgesFromFacesRuntime;
  }
